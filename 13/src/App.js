...
const UserOrders = lazy(() => import('./components/user/components/orders/orders'));
const UserSocial = lazy(() => import('./components/user/components/social/social'));
const UserPremium = lazy(() => import('./components/user/components/premium/premium'));
...
function App() {
  ...
  return (
    <div className="App">
      <BrowserRouter>
        <AppContext.Provider value={{ user, setUser, userID, setUserID, shopuser, setShopuser, amounttopay, setAmounttopay }}>
          <Header />
          <main>
            <Suspense fallback={<div id="app_fallback">Loading ...</div>}>
              <Routes>
                ...
                <Route path="user" element={<User />} >
                  ...
                  <Route path="premium" element={<UserPremium />} />
                </Route>
